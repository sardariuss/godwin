...
module {
  ...
  public class TestQueries() = {
    ...
    let question_0 =                           { id = 0; author = principal_0; title = "Selfishness is the overriding drive in the human species, no matter the context."; text = ""; date = 8493; endorsements = 13; selection_stage = [{ timestamp = 8493; stage = #CREATED;  }]; categorization_stage = [{ timestamp = 1283; stage = #PENDING;  }]; };
    let question_0_text_update =               { id = 0; author = principal_0; title = "Above all is selfishness is the overriding drive in the human species";            text = ""; date = 8493; endorsements = 13; selection_stage = [{ timestamp = 8493; stage = #CREATED;  }]; categorization_stage = [{ timestamp = 1283; stage = #PENDING;  }]; };
    let question_1 =                           { id = 1; author = principal_1; title = "Patents should not exist.";                                                        text = ""; date = 2432; endorsements = 2;  selection_stage = [{ timestamp = 2432; stage = #ARCHIVED; }]; categorization_stage = [{ timestamp = 9372; stage = #ONGOING;  }]; };
    let question_1_date_update =               { id = 1; author = principal_1; title = "Patents should not exist.";                                                        text = ""; date = 5123; endorsements = 2;  selection_stage = [{ timestamp = 2432; stage = #ARCHIVED; }]; categorization_stage = [{ timestamp = 9372; stage = #ONGOING;  }]; };
    let question_2 =                           { id = 2; author = principal_2; title = "Marriage should be abolished.";                                                    text = ""; date = 3132; endorsements = 43; selection_stage = [{ timestamp = 3132; stage = #SELECTED; }]; categorization_stage = [{ timestamp = 3610; stage = #DONE([]); }]; };
    let question_2_endorsements_update =       { id = 2; author = principal_2; title = "Marriage should be abolished.";                                                    text = ""; date = 3132; endorsements = 9;  selection_stage = [{ timestamp = 3132; stage = #SELECTED; }]; categorization_stage = [{ timestamp = 3610; stage = #DONE([]); }]; };
    let question_3 =                           { id = 3; author = principal_3; title = "It is necessary to massively invest in research to improve productivity.";         text = ""; date = 4213; endorsements = 21; selection_stage = [{ timestamp = 4213; stage = #CREATED;  }]; categorization_stage = [{ timestamp = 4721; stage = #PENDING;  }]; };
    let question_3_selection_stage_update =    { id = 3; author = principal_3; title = "It is necessary to massively invest in research to improve productivity.";         text = ""; date = 4213; endorsements = 21; selection_stage = [{ timestamp = 4213; stage = #ARCHIVED; }]; categorization_stage = [{ timestamp = 4721; stage = #PENDING;  }]; };
    let question_4 =                           { id = 4; author = principal_4; title = "Insurrection is necessary to deeply change society.";                              text = ""; date = 9711; endorsements = 20; selection_stage = [{ timestamp = 9711; stage = #SELECTED; }]; categorization_stage = [{ timestamp = 9473; stage = #DONE([]); }]; };
    let question_4_categorization_update =     { id = 4; author = principal_4; title = "Insurrection is necessary to deeply change society.";                              text = ""; date = 9711; endorsements = 20; selection_stage = [{ timestamp = 9711; stage = #SELECTED; }]; categorization_stage = [{ timestamp = 9473; stage = #PENDING;  }]; };
