...
module {
  ...
  public class TestQueries() = {
    ...
    let question_1 =                           { id = 1; author = Principal.fromText("2an7n-c4inx-7otxp-f4gmm-lz4yk-z6rvd-ogxe4-fype3-icqva-w5ylq-sae"); title = "Patents should not exist.";                                                        text = ""; date = 2432; endorsements = 2;  selection_stage = [{ timestamp = 2432; stage = #ARCHIVED { agree = 0.0; neutral = 0.0; disagree = 0.0; }; }]; categorization_stage = [{ timestamp = 9372; stage = #ONGOING;  }]; };
    let question_1_date_update =               { id = 1; author = Principal.fromText("2an7n-c4inx-7otxp-f4gmm-lz4yk-z6rvd-ogxe4-fype3-icqva-w5ylq-sae"); title = "Patents should not exist.";                                                        text = ""; date = 5123; endorsements = 2;  selection_stage = [{ timestamp = 2432; stage = #ARCHIVED { agree = 0.0; neutral = 0.0; disagree = 0.0; }; }]; categorization_stage = [{ timestamp = 9372; stage = #ONGOING;  }]; };
    ...
    let question_3_selection_stage_update =    { id = 3; author = Principal.fromText("ytsdx-ddotz-rkcxu-mfivi-nvtwo-cv5ip-uw5jh-7om6u-gano3-ev6sl-3qe"); title = "It is necessary to massively invest in research to improve productivity.";         text = ""; date = 4213; endorsements = 21; selection_stage = [{ timestamp = 4213; stage = #ARCHIVED { agree = 0.0; neutral = 0.0; disagree = 0.0; }; }]; categorization_stage = [{ timestamp = 4721; stage = #PENDING;  }]; };
