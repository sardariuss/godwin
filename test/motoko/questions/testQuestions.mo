...
module {
  ...
  public class TestQuestions() = {
    ...
    let array_modified_ : [Question] = [
      ...
      { id = 2; author = Principal.fromText("zl5om-yevaq-syyny-vn5bl-ahjnu-cc2qx-b7oqi-ojbct-xrxjw-ivql6-uqe"); title = "A good citizen is a patriot.";               text = ""; date = 2432; endorsements = 32; selection_stage = [{ timestamp = 2432; stage = #ARCHIVED({ left = 0.0; center = 10.0; right = 0.0; }) }]; categorization_stage = [{ timestamp = 2432; stage = #ONGOING;  }]; },
      { id = 3; author = Principal.fromText("ytsdx-ddotz-rkcxu-mfivi-nvtwo-cv5ip-uw5jh-7om6u-gano3-ev6sl-3qe"); title = "The labor market enslaves workers.";         text = ""; date = 1321; endorsements = 2;  selection_stage = [{ timestamp = 1321; stage = #ARCHIVED({ left = 0.0; center = 10.0; right = 0.0; }) }]; categorization_stage = [{ timestamp = 1321; stage = #ONGOING;  }]; },
      ...
      { id = 7; author = Principal.fromText("gbvlf-igtmq-g5vs2-skrhr-txgij-4f2j3-v2jqy-re5cm-i6hsu-gpzcd-aae"); title = "We must fight against global warming.";      text = ""; date = 3421; endorsements = 21; selection_stage = [{ timestamp = 3421; stage = #ARCHIVED({ left = 0.0; center = 10.0; right = 0.0; }) }]; categorization_stage = [{ timestamp = 3421; stage = #PENDING;  }]; },
