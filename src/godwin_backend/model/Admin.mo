...
module {
  ...
  //          }
  //        };
  //        case(#VOTING(#CATEGORIZATION({ interest_score; opinion_aggregate; categorization_aggregate; }))) {
  //          {
  //            question with
  //            interests_history = [Vote.new<Interest, Appeal>(date, { ups = 0; downs = 0; score = 0; })];
  //            status = #VOTING({ stage = #CATEGORIZATION; iteration = {
  //              opinion = Vote.new<Cursor, Polarization>(date, opinion_aggregate);
