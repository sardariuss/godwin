...
const ChartTypeToggle = ({chartType, setChartType}: ChartTypeToggleProps) => {
  return (
    <div className="flex flex-row w-full items-center justify-center place-self-center">
      <div className={`w-1/6 hover:dark:fill-white hover:cursor-pointer rotate-90 rounded-lg ${chartType === ChartTypeEnum.Bar     ? "fill-black dark:fill-white bg-gray-200 dark:bg-gray-800" : "fill-gray-600 dark:fill-gray-400"}`} onClick={(e) => setChartType(ChartTypeEnum.Bar)}>
      ...
      <div className={`w-1/6 hover:dark:fill-white hover:cursor-pointer           rounded-lg ${chartType === ChartTypeEnum.Scatter ? "fill-black dark:fill-white bg-gray-200 dark:bg-gray-800" : "fill-gray-600 dark:fill-gray-400"}`} onClick={(e) => setChartType(ChartTypeEnum.Scatter)}>
