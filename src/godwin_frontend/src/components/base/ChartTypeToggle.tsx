...
const ChartTypeToggle = ({chartType, setChartType}: ChartTypeToggleProps) => {
  return (
    <div className="flex flex-row w-full items-center justify-center place-self-center">
      <div className={`w-1/6 hover:dark:fill-white hover:cursor-pointer rotate-90 rounded-lg ${chartType === ChartTypeEnum.Bar     ? "dark:fill-white bg-gray-800" : "dark:fill-gray-400"}`} onClick={(e) => setChartType(ChartTypeEnum.Bar)}>
      ...
      <div className={`w-1/6 hover:dark:fill-white hover:cursor-pointer           rounded-lg ${chartType === ChartTypeEnum.Scatter ? "dark:fill-white bg-gray-800" : "dark:fill-gray-400"}`} onClick={(e) => setChartType(ChartTypeEnum.Scatter)}>
