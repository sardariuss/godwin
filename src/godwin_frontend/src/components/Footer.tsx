...
function Footer() {
  return (
		<>
      <footer className="p-4 w-full bg-slate-100 dark:bg-gray-800 shadow p-6 flex flex-row items-center justify-end space-x-2">
        <a href="https://internetcomputer.org/" className="place-self-start self-start">
