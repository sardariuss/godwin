...
import { nsToStrDate, putBallotErrorToString } from "../../utils";
...
const VoteCategorization = ({actor, categories, voteId}: Props) => {
...
//    let categorization_vote = await actor.putCategorizationBallot(voteId, categorization);
