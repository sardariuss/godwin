...
export SUB_PARAMETERS=$(cat ./test/scenario/parameters/uspolitics.did)
export SUB_COMMAND="dfx canister call godwin_master createSubGodwin '(\"classic7\", "$SUB_PARAMETERS")'"
echo "$SUB_COMMAND"
